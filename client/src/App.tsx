      ...
      <nav className="bg-secondary py-4 px-6 shadow-lg">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <a href="#games" className="hover:text-accent transition">Games</a>
      ...
      <main>
        ...
        <section className="bg-gradient-to-br from-secondary to-background py-12 px-6">
          <div className="container mx-auto text-center">
            ...
            <div className="mt-8">
              <button className="px-6 py-2 bg-accent text-white rounded-md hover:bg-accent/80">
                Get Started
              </button>
            </div>
          </div>
              ...
              <div className="bg-background p-6 rounded-lg">
                ...
                <div className="flex justify-center p-6 bg-secondary rounded-lg">
                  <div className="w-16 h-16 bg-card rounded-full flex items-center justify-center">
                    <span className="text-error text-xl">36</span>
                  </div>
                </div>
                <p className="mt-4 text-center text-muted-foreground">Place your bets on numbers or colors!</p>
              </div>
            </div>
          </div>
        </section>
              ...
              <div className="bg-card p-6 rounded-lg">
                ...
                <ul className="space-y-2">
                  ...
                  <li className="flex justify-between">
                    ...
                    <span className="text-muted-foreground">Play roulette</span>
                  </li>
                </ul>
              </div>
